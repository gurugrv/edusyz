...
class ExamGroupsController < ApplicationController
  ...
  filter_access_to :all, :except=>[:index,:show,:set_exam_maximum_marks,:set_exam_minimum_marks]
  filter_access_to [:index,:show,:set_exam_maximum_marks,:set_exam_minimum_marks], :attribute_check=>true, :load_method => lambda { current_user }
