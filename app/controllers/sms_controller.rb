...
class SmsController < ApplicationController
  ...
  filter_access_to :index, :settings,:update_general_sms_settings
  ...
  filter_access_to :show_sms_messages,:sms_all, :list_employees,:show_sms_logs ,:attribute_check => true,:load_method => lambda {SmsSetting.find_by_settings_key("ApplicationEnabled")}
